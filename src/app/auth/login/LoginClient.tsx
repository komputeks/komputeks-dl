  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="w-full bg-dark border border-edge rounded-lg pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:border-neon" placeholder="••••••••" />
              </div>
            </div>
        ...
        <p className="text-center text-muted text-sm mt-6">No account? <Link href="/auth/signup" className="text-neon hover:underline">Sign up free</Link></p>
        <div className="mt-4 text-center text-xs text-muted">
          <p>Demo: admin@komputeks.com / komputeks123</p>
        </div>
      </div>
    </div>
  );
